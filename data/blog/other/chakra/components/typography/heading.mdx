...
the default theme. This can be seen in the [theme source](https://github.com/chakra-ui/chakra-ui/blob/main/packages/theme/src/components/heading.ts) for the component.
...
`noOfLines` prop. This will render an ellipsis when the heading exceeds the width
